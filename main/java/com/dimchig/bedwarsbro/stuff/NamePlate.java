	...
	public void draw(Vec3 pos, boolean isRainbow, boolean isTeamColor, int rainbowSpeed, String constantColor) {
        ...
        if (isTeamColor) {        	
        	...
        	if (team_color != TEAM_COLOR.NONE) {
        		isRainbow = false;
	        	if (team_color == TEAM_COLOR.RED)          constantColor = "#ff0000";
				else if (team_color == TEAM_COLOR.YELLOW)  constantColor = "#ffff00";
				else if (team_color == TEAM_COLOR.GREEN)   constantColor = "#00ff00";
				else if (team_color == TEAM_COLOR.AQUA)    constantColor = "#00ffff";
				else if (team_color == TEAM_COLOR.BLUE)    constantColor = "#0055ff";
				else if (team_color == TEAM_COLOR.PINK)    constantColor = "#ff00ff";
				else if (team_color == TEAM_COLOR.WHITE)   constantColor = "#ffffff";
				else if (team_color == TEAM_COLOR.GRAY)    constantColor = "#b5b5b5";
