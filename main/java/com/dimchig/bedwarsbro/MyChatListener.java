...
public class MyChatListener {
    ...
    public static int bwmanipulator_party_info = -1;
    ...
    public static void initChatMessages() {
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_LEFT_PREGAME,
                "§r§6§lBedWars §r§8%skip% §r%player% §r§fпокинул игру §r§c%cnt_players_current%/%cnt_players_total%§r", new String[]{"skip", "player", "cnt_players_current", "cnt_players_total"}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_GAME_STARTED,
                "§r§eЗащити свою кровать и сломай чужие кровати.§r", new String[]{"", ""}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_JOINED_PREGAME,
                "§r§6§lBedWars §r§8%skip% §r%player% §r§fподключился к игре §r§a%cnt_players_current%/%cnt_players_total%§r", new String[]{"skip", "player", "cnt_players_current", "cnt_players_total"}));
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_SUICIDE,
                "§r§6§lBedWars §r§8%skip% §r%player% §r§fпогиб.§r", new String[]{"skip", "player", ""}));
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_KILLED_BY_VOID,
                "§r§6§lBedWars §r§8%skip% §r%victim% §r§fбыл скинут в бездну игроком §r%killer%§r§f.§r", new String[]{"skip", "victim", "killer"}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_KILLED_BY_PLAYER,
                "§r§6§lBedWars §r§8%skip% §r%victim% §r§fбыл убит игроком §r%killer%§r§f.§r", new String[]{"skip", "victim", "killer"}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_TEAM_DESTROYED,
                "§r§6§lBedWars §r§8%skip% §r§fКоманда §r%team% §r§fуничтожена!§r", new String[]{"skip", "team", ""}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_TEAM_BED_BROKEN,
                "§r§6§lBedWars §r§8%skip% §r%player% §r§fразрушил кровать команды §r%team%§r§f!§r", new String[]{"skip", "player", "team"}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_TEAM_COLOR_CHOSEN,
                "§r§6§lBedWars §r§8%skip% §r§fВы выбрали команду §r%team%§r§f!§r", new String[]{"skip", "team", ""}));
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_SHOP_ITEM_BOUGHT,
                "§r§7Вы купили §r§a%item%§r §ax%amount%§r", new String[]{"item", "amount"}));
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_UPGRADE_BOUGHT,
                "§r§6§lBedWars §r§8%skip% §r§fИгрок §r§f%player% §r§fпрокачал улучшение §r§b%upgrade% §r§fдо уровня §r§b%level%§r§f!", new String[]{"skip", "player", "upgrade", "level"}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_GENERATOR_DIAMOND_LEVELED_UP,
                "§r§6§lBedWars §r§8%skip% §r§fГенераторы §r§bалмазов§r§f прокачаны до уровня §r§a%level%§r§f", new String[]{"skip", "level", ""}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_GENERATOR_EMERALD_LEVELED_UP,
                "§r§6§lBedWars §r§8%skip% §r§fГенераторы §r§aизумрудов§r§f прокачаны до уровня §r§a%level%§r§f.§r", new String[]{"skip", "level", ""}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_TRAP_ACTIVATED,
                "§r§6§lBedWars §r§8%skip% §r§cЛовушка сработала, на вашем острове враг!§r", new String[]{"skip", "", ""}));
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_CONNECTING_TO_LOBBY,
                "§aПодключение к %lobby%...§r", new String[]{"lobby", ""})); //if not %lobby% contains lobby - it is game
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_HUB_CHAT_PLAYER_MESSAGE,
                "§r§r%player% §8 §8%skip% §7§r%message%§r", new String[]{"player", "skip", "message"}));
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_GAME_STARTS_IN_SECONDS,
                "§r§6§lBedWars §r§8%skip% §r§eДо старта осталось §r§c%seconds%§r§e секунд...§r", new String[]{"skip", "seconds", ""}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_GAME_CHAT_LOCAL,
                "§r§r%teamcolor%[⚑] %player% §8%skip% §7§r%message%§r", new String[]{"teamcolor", "player", "skip", "message"}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_GAME_CHAT_GLOBAL,
                "§r§r%teamcolor%[Всем] %player% §8%skip% §7§r%message%§r", new String[]{"teamcolor", "player", "skip", "message"}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_GAME_CHAT_SPECTATOR,
                "§r§r§7Наблюдатель §8| §f%player% §8%skip% §7§r%message%§r", new String[]{"player", "skip", "message"}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_GAME_CHAT_PREGAME,
                "§r§r§f%player% §8→ §7§r§7§7%message%§r", new String[]{"player", "message"}));
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_PLAYER_BANNED,
                "§r§6АнтиЧит§r§8 %skip% §rИгрок §r§c%player% §r§fбыл временно §r§cзабанен §r§fпо подозрению в использовании читов.§r", new String[]{"skip", "player"}));
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_BEDWARS_END_TOP_KILLER,
                "§r%skip%                      §r%place% §r§7- §r§7%player% §r§7(%kills_cnt%)§r", new String[]{"skip", "place", "player", "kills_cnt"}));
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_LOBBY_PARTY_INVITE,
                "§r§6Party §r§8%skip% §r§fВы отправили приглашение игроку §r§e%player%§r", new String[]{"skip", "player"}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_LOBBY_PARTY_INVITE_REJECTED,
                "§r§6Party §r§8%skip% §r§cВаше приглашение в пати игрока §r§c§l%player% §r§cистекло§r", new String[]{"skip", "player"}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_LOBBY_PARTY_WARP,
        		"§r§6Party §r§8%skip% §r§cВы отправили запрос на перемещение игроков из пати к вам§r", new String[]{"skip", ""}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_LOBBY_PARTY_PLAYER_OFFLINE,
        		"§r§6Party §r§8%skip% §r§cИгрок §r§c§l%player%§r§c кикнут из пати поскольку он оффлайн %reason%§r", new String[]{"skip", "player", "reason"}));
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_LOBBY_STATS_PLAYER,
                "§r§e§lСтатистика §r§8%skip% §r§f%player%§r", new String[]{"skip", "player"}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_LOBBY_STATS_CATEGORY,
                "§r§e%skip% §r§f%category%: §r§e%cnt% §r§a(Твое место %place%)§r", new String[]{"skip", "category", "cnt", "place"}));
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_LOBBY_PARTY_PLAYER_KICKED,
        		"§r§6Party §r§8%skip% §r§fИгрок §r§e%player%§r§f был кикнут из пати§r", new String[]{"skip", "player"}));  
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_LOBBY_PARTY_NEW_LEADER,
        		"§r§6Party §r§8%skip% §r§fИгрок §r§e%player% §r§fстал новым создателем пати§r", new String[]{"skip", "player"}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_LOBBY_PARTY_COMMANDS_DONT_WORK_IN_LOBBY,
        		"§r§6Party §r§8%skip% §r§fКоманды пати работают только в бедрварс лобби/игре.§r", new String[]{"skip", ""}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_LOBBY_PARTY_CHAT_MESSAGE,
        		"§r§6Party §r§8%skip% §r§e%player% §r§fпишет:§r§7 %message%§r", new String[]{"skip", "player", "message"}));     
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_LOBBY_PARTY_DISBAND_REQUEST,
        		"§r§6Party §r§8%skip% §r§cСоздатель пати %player% запросил расформирование!§r", new String[]{"skip", "player"})); 
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_LOBBY_PARTY_NOT_ENOUGH_SPACE,
        		"§r§6Party §r§8%skip% §r§cНа этой арене не хватает слотов для всего пати, выберите другую арену§r", new String[]{"skip"}));
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_LOBBY_PARTY_OWNER_LEFT,
        		"§r§6Party §r§8%skip% §r§cСоздатель пати %player% покинул его, пати сейчас будет расфомировано!§r", new String[]{"skip", "player"}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_LOBBY_PARTY_REQUEST,
        		"§eНажмите сюда §fчтобы присоединиться! У вас есть", new String[]{""}));
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_LOBBY_PARTY_INFO,
        		"▸ Информация о пати", new String[]{""}));
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAY_YOU_ALREADY_ON_SERVER,
        		"§cВы уже на сервере!§r", new String[]{"", ""}));        
        ...
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_GAME_YOU_CANT_USE_COLOR,
        		"Вы не можете использовать цвет", new String[]{"", ""}));             
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_GAME_ANTI_CHEAT_KICK,
        		"§r§6АнтиЧит§r§8 %skip% §rИгрок §r§c%player% §r§fбыл §r§cкикнут §r§fпо подозрению в использовании читов.§r", new String[]{"skip", "player"}));
        chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_HUB_ANTIFLOOD,
        		"§r§6АнтиФлуд§r§8 %skip% §rИгрок §r§c%player% §r§fбыл §r§cзамучен §r§fс причиной: '§r§cПовторение однотипных сообщений§r§f'§r", new String[]{"skip", "player"}));
        		

        //add bedwars game started
        String[] chatMessagesGameStarted = {
                "§r§f                           §r§c§lКРОВАТНЫЕ ВОЙНЫ§r",
                "§r§c§l  §r§f                          §r",
                "§r§e          §r§eПокупай предметы и улучшения для своей команды за§r",
                "§r§e        §r§eЖелезо, Золото, Алмазы и Изумруды чтобы стать несокрушимыми!§r",
                "§r§e                 §r§eПобедит только одна, сильнейшая команда!§r",
                "§r§e  §r§f                §r§a   Вы играете на §r§amc.MineBlaze.ru§r",
                "§r§e  §r§f                §r§a   Вы играете на §r§amc.DexLand.ru§r",
        };
        for (String s: chatMessagesGameStarted) chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_BEDWARS_GAME_STARTED_TIPS, s, new String[]{""}, true));

        //add ads
        String[] chatMessagesAds = {
                "Сайт для совершения покупок:",
                "Привилегии [GOLD]",
                "Доступно: /sit",
                "Хотите купить донат, но сомневаетесь?",
                "Чтобы посмотреть свою или чужую статистику",
                "Хотите изменить свой ник?",
                "Хотите быть первым вкурсе всех новостей сервера?",
                "Хотите выиграть Айфон 11 PRO?",
                "Помогите нам улучшить сервер",
                "Хотите получить все команды сервера и опку?",
                "Покупка кейса производится на сайте",
                "Не знаете какие возможности есть у доната?",
                "ВКонтакте - ",
                "Для чего это нужно (Наведи мышкой)",
                "Вы случайно вышли из игры и хотите вернуться?",
                "Чтобы посмотреть топы по всем категориям",
                "Успейте купить донат по дешевым ценам",
                
                "Хочешь купить донат, но сомневаешься?",
                "Не знаешь какие возможности есть у доната?",
                "Но ты не готов тратить много денег?",
                "Хотел бы снимать антигрифер шоу?",
                "Друзья хвастаются донатом? А ты никто?",
                "Хочешь купить донат, но не доверяешь?",
                "Сайт для покупки доната",
                "Донат покупать только на сайте",
                "Только сегодня у тебя есть возможность купить донат",
                "Хочешь получить 85% команд ОЧЕНЬ дешево",
                "Хочешь быть в курсе новостей сервера?",
                "Купить донат на нашем сайте можно через:",
                "На нашем сайте есть оплата с мобильного телефона",
                "Тебе нужен доступ в любой приват?",
                "Хочешь показать всем кто тут главный?",
                "Купить донат на нашем сайте можно через:",
                "Помогите нам улучшить сервер",
                "У нас появился новый донат",
                "Все донат-привилегии и кейсы",
                
                
                "Важно для вашей безопасности"};
        for (String s: chatMessagesAds) chatMessages.add(new ChatMessage(CHAT_MESSAGE.CHAT_ADS, s, new String[]{""}));
        ...
        for (ChatMessage m: temp) {
        	if (m.type != CHAT_MESSAGE.NONE) chatMessages.add(m);
        }  
    }
    ...
    public static ChatMessage findChatMessage(String str) {
        ...
        for (ChatMessage chatMessage: chatMessages) {
            if (chatMessage.elements.length == 0) {
            	...
            	if (chatMessage.type == CHAT_MESSAGE.CHAT_ADS) message_text = ColorCodesManager.removeColorCodes(message_text);
                ...
                try {
	                for (int i = 0; i < chatMessage.elements.length; i++) {
	                    ...
	                    if (i == chatMessage.elements.length - 1) parts.add(s);
	                }
                } catch (Exception ex) {
                ...
                //ChatSender.addText("\n" + str + "\n&r" + chatMessage.message + "\n&a" + Arrays.toString(chatMessage.elements) + "\n&e" + parts + "\n");
                
                if (!isFound || parts.size() < 2) continue;
                ...
                try {
                    ...
                    for (int i = 0; i < parts.size() - 1; i++) {
                    	//String val = str.split(Pattern.quote(parts.get(i)))[1].split(Pattern.quote(parts.get(i + 1)))[0].trim();
	...
	public void onJoinServer(FMLNetworkEvent.ClientConnectedToServerEvent e) {
    	...
    	new Timer().schedule( 
    	        new TimerTask() {
    	            @Override
    	            public void run() {
    	            	if (Minecraft.getMinecraft() == null || Minecraft.getMinecraft().ingameGUI == null || Minecraft.getMinecraft().ingameGUI.getChatGUI() == null) return;    	
    ...
    {    	
        ...
        if (instance == null) {
        	...
        	if (e.message.getUnformattedText().length() == 0) e.message = null;
            return;    
        }
    ...
    public static String formatChatPlayerName(IChatComponent message, String player_name, String player_color, boolean removeColor) {
        ...
        if (player_name.contains(" ")) {
        	...
        	/*String[] available_formats = new String[] {"§7[Игрок]§F§r", "&8§7[Игрок]", "§7[Игрок]§f", "§7[Игрок]"};
        	for (int i = 0; i < available_formats.length; i++) {
        		if (player_name.contains(" ") && player_name.contains(available_formats[i])) {
        			player_name = player_name.replace(available_formats[i], "").trim();
        		}
        	}*/
        ...
        if (hoverText.length() > 0 && hoverText.split(" ").length == 2 && hoverText.contains("Ник:")) {
        	...
        	if (!hoverName.equals(player_name)) player_name = hoverName + "*";
        }
    ...
    public static String getGeneratorDiamondUpgradeTime(String upgrade) {   	
    	...
    	int current_level = -1;
    	if (upgrade.contains("II")) current_level = 2;
    	else if (upgrade.contains("I")) current_level = 1;
    ...
    public static String highLightExtras(String text) {
    	...
    	//text = text.replaceAll("(?i)" + Pattern.quote(player_name), "&e" + player_name + "&f");
    ...
    public static String highLightDiscord(String text) {
    	...
    	if (discord != null) text = text.replace(discord, color + "" + discord + "&f");
    	...
    	new Timer().schedule( 
    	        new TimerTask() {
    	            ...
    	            public void run() {
    	            	...
    	            	ArrayList<BWBed> beds = HintsBedScanner.findBeds(player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
    	            	if (beds.size() == 0) {
    	            		...
    	            		int min_dist = 999999;
    	            		for (BWBed b: beds) {
    	            			int dist = (int)Math.sqrt(Math.pow(b.part1_posX - player.posX, 2) + Math.pow(b.part1_posZ - player.posZ, 2));
    	            			if (dist < min_dist) {
    	            				min_dist = dist;
    	            				GAME_BED = b;
    	            			}
    	            		...
    	            		/*ChatSender.addText("&einiting");
    	            		Main.minimap.initGameBeds();*/
    	...
    	try {
        	...
        	for (CustomScoreboard.BedwarsTeam t: teams) {
        		if (t.color == team_color) {
        			if (t.state == TEAM_STATE.DESTROYED || (t.state == TEAM_STATE.BED_BROKEN && t.players.size() == 1)) {
    ...
    public static boolean isUserMuted(String player_name) {
    	if (Main.getConfigString(CONFIG_MSG.MUTED_PLAYERS) == null) return false;
    	String[] muted_players = Main.getConfigString(CONFIG_MSG.MUTED_PLAYERS).split(",");
    	for (String p: muted_players) {
    		String name = p.trim();
    		...
    		if (name.equals(player_name)) {
    			...
    			if (player_name.toLowerCase().contains(name.toLowerCase())) return true;
    		}
    	}
    	return false;
    }
    ...
    public static void addBedwarsMeowMessageToQuee(String s, boolean isInGameOnly) {
    	if (meowMessagesQuee == null) meowMessagesQuee = new ArrayList<MsgMeowQuee>();
    ...
    static void handleBedwarsMeowMessagesQuee() {
    	if (meowMessagesQuee.size() <= 0) return;
    ...
    static void checkBedwarsMeowMessagesQueelastMessage(String text) {
    	if (meowMessagesQuee.size() <= 0 || quee_last_meow_message == null) return;
    	
    	if (ColorCodesManager.removeColorCodes(text).contains(ColorCodesManager.removeColorCodes(quee_last_meow_message.text))) {
    		meowMessagesQuee.remove(quee_last_meow_message);
    		quee_last_meow_message = null;
    	}
    }
    ...
    static void handleBedwarsMeowKillType(ClientChatReceivedEvent e, String p_killer, String p_victim, MsgCase msgcase) {
    	...
    	/*ChatSender.addText(e.message.getFormattedText());
    	deleteMessage(e);*/
    	...
    	//KILL EVENT
    	if (!mod_player_name.equals(killer)) return;    	
    	GAME_total_kills++;
    ...
    static void handleBedwarsMeowBed(TEAM_COLOR team_color, String p_player) {
    	String player = ColorCodesManager.removeColorCodes(p_player).trim();
    	if (!Minecraft.getMinecraft().thePlayer.getName().equals(player)) return;
    	...
    	for (CustomScoreboard.BedwarsTeam t: teams) {
    		if (t.color == team_color) {
    			if (t.players.size() <= 1) isSingleMode = true;
    			break;
    		}
    	}
    	
    	MsgCase msgcase = MsgCase.BED_MULTI;
    	if (isSingleMode) msgcase = MsgCase.BED_SINGLE;
    	    	
    	String s = Main.bedwarsMeow.getNextMessage(msgcase, CustomScoreboard.getCodeByTeamColor(team_color));
    	if (s == null) return;
    	addBedwarsMeowMessageToQuee(s, true);
    }
    ...
    static void handleBedwarsMeowWin(String p_team_name) {
    	...
    	if (mod_team_color == team_color) return;
    ...
    public static void handleReceivedMessage(ClientChatReceivedEvent e, ChatMessage chatMessage) {
        ...
        checkBedwarsMeowMessagesQueelastMessage(e.message.getUnformattedText());
        ...
        switch (msg.type) {
            ...
            case CHAT_GAME_STARTED:
                ...
                if (HintsValidator.isBedScannerActive()) readPlayerBase();
                IS_IN_GAME = true;
            ...
            case CHAT_BEDWARS_GAME_STARTED_TIPS:
            	if (IS_MOD_ACTIVE) deleteMessage(e);
                break;
            ...
            case CHAT_SUICIDE:
            	...
            	if (isItFinalKill(victim)) {
            		...
            		if (ColorCodesManager.removeColorCodes(victim).trim().equals(Minecraft.getMinecraft().thePlayer.getName())) GAME_total_death++;
            	}
                setMessageText(e, str);
                break;
            ...
            case CHAT_TEAM_BED_BROKEN:
            	if (IS_MOD_ACTIVE) {
	                ...
	                if (vals[1].length() > 2) str += "" + vals[1].substring(0, 2) + "*";
            ...
            case CHAT_SHOP_ITEM_BOUGHT:
                ...
                if (Main.getConfigBool(CONFIG_MSG.REMOVE_BUY_MESSAGE)) deleteMessage(e); 
                else setMessageText(e, str);
            ...
            case CHAT_GENERATOR_DIAMOND_LEVELED_UP:
                ...
                try { Main.generatorTimers.setMaxTimeDiamonds(Integer.parseInt(new_time)); }
                catch (Exception ex) {}
            ...
            case CHAT_GENERATOR_EMERALD_LEVELED_UP:
            	...
            	try { Main.generatorTimers.setMaxTimeEmeralds(Integer.parseInt(new_time)); }
                catch (Exception ex) {}
            ...
            case CHAT_HUB_CHAT_PLAYER_MESSAGE:
            	...
            	String text = vals[2].replaceFirst("§7§7","");
            	String message_hover_text = getHoverMessage(e.message);

            	if (Main.isPropUserAdmin(player_name)) {
            		if (vals[2].toLowerCase().contains("я автор мода")) {
            			deleteMessage(e);
            			ChatSender.addText(Main.chatListener.PREFIX_BEDWARSBRO + "&bНа данный момент создатель мода играет под ником \"&e" + player_name + "&b\"");
            			playSound(SOUND_PARTY_CHAT);
            			break;
            		} else if (vals[2].toLowerCase().contains("кто с модом?")) {
            			ChatSender.sendText("!Я играю с модом!");
            		}
            	}
            	...
            	if (IS_MOD_ACTIVE) {
            		...
            		if (message_hover_text.length() > 0) {
            			...
            			if (split.length >= 2) { 
	            			...
	            			if (hover_data.contains("Убийств ▸") && hover_data.contains("K/D ▸ ") && Main.getConfigBool(CONFIG_MSG.ENABLE_BETTER_CHAT_STATISTIC_PREFIX)) {
	            				try {
	            					//kdr = hover_data.split("Убийств ▸")[1].trim().split(" ")[0];
	            					
	            					int kills = Integer.parseInt(hover_data.split("Убийств ▸")[1].trim().split(" ")[0].trim().replace(",", ""));
	            					int games_cnt = Integer.parseInt(hover_data.split("Игр ▸")[1].trim().split(" ")[0].trim().replace(",", ""));
	            					int wins_cnt = Integer.parseInt(hover_data.split("Побед ▸")[1].trim().split(" ")[0].trim().replace(",", ""));
	            					...
	            					if (kills > 100) {
		            					...
		            					if (kills < 500) kills_color = "&c";
		            					else if (kills < 1000) kills_color = "&6";
		            					else if (kills < 2000) kills_color = "&e";
		            					else if (kills < 5000) kills_color = "&a";
		            					else if (kills < 10000) kills_color = "&a&l";
		            					else if (kills < 20000) kills_color = "&a&l&n";
		            					else if (kills >= 40000) kills_color = "&b&l&n";
		            					
		            					String kdr_color = "&c";
		            					double kdr = Double.parseDouble(hover_data.split("K/D ▸ ")[1].trim().split(" ")[0].split("\n")[0].trim());
		            					if (kdr < 1) kdr_color = "&c";
		            					else if (kdr < 1.5) kdr_color = "&6";
		            					else if (kdr < 2) kdr_color = "&e";
		            					else if (kdr < 3) kdr_color = "&a";
		            					else if (kdr < 4) kdr_color = "&a&l";
		            					else if (kdr < 5) kdr_color = "&a&l&n";
		            					else if (kdr >= 5) kdr_color = "&b&l&n";
		            					...
		            					if (games_cnt > 0) {
			            					...
			            					if (wr < 10) wr_color = "&c";
			            					else if (wr < 20) wr_color = "&6";
			            					else if (wr < 30) wr_color = "&e";
			            					else if (wr < 40) wr_color = "&a";
			            					else if (wr < 50) wr_color = "&a&l";
			            					else if (wr < 60) wr_color = "&a&l&n";
			            					else if (wr >= 70) wr_color = "&b&l&n";
		            					}
	            			...
	            			String real_name = ColorCodesManager.removeColorCodes(split[1].trim());	   

	            			if (isUserMuted(real_name) == true) {
	    	            		deleteMessage(e);
	    	            		/*str = "&c&lMUTED &b" + player_name;
	    	            		setMessageText(e, str);*/
	    	            		return;
	    	            	} 
            ...
            case CHAT_GAME_CHAT_LOCAL:
            	if (IS_MOD_ACTIVE) {
                	...
                	if (name2copy.split(" ").length == 2) name2copy = name2copy.split(" ")[1].trim().replaceFirst("~", "");
            ...
            case CHAT_GAME_CHAT_GLOBAL:
            	...
            	String n = formatChatPlayerName(e.message, vals[1], vals[0], true);
            	if (n.contains(" ")) n = n.split(" ")[1].trim();
             	
            	if (Main.isPropUserAdmin(n.replace("*", "").trim()) && vals[3].contains("Я автор мода")) {
            		deleteMessage(e);
            		ChatSender.addText(Main.chatListener.PREFIX_BEDWARSBRO + "&bНа данный момент создатель мода играет под ником \"&e" + n.replace("*", "").trim() + "&b\"");
            		playSound(SOUND_PARTY_CHAT);
            		break;
            	}
            	...
            	if (IS_MOD_ACTIVE) {
	            	...
	            	str = "&r" + mod_prefix + "" + vals[0] + "" + formatChatPlayerName(e.message, vals[1], vals[0], true) + " &8→ &f" + vals[3];
	            	deleteMessage(e);
	            	String name2copy = ColorCodesManager.removeColorCodes(vals[1]);
                	if (name2copy.split(" ").length == 2) name2copy = name2copy.split(" ")[1].trim().replaceFirst("~", "");
                	ChatSender.addClickSuggestAndHoverText(str, vals[1], name2copy);
            ...
            case CHAT_PLAYER_BANNED:
                str = PREFIX_ANTICHEAT + "&fДаун &c&l" + ColorCodesManager.removeColorCodes(vals[1]) + " &fчитер и был &cзабанен&f!";
                setMessageText(e, str);
                break;
            ...
            case CHAT_BEDWARS_END_TEAM_WON:
                ...
                if (HintsValidator.isWinEmoteActive()) WinEmote.changeWorldBlocks(CustomScoreboard.getTeamColorByCode(vals[0].substring(0, 2)));
                setMessageText(e, str);
   ...
   //====PARTY    
            ...
            case CHAT_LOBBY_PARTY_YOU_ARE_NOT_IN_PARTY:
            	...
            	if (bwmanipulator_party_info == 1) {
    				bwmanipulator_party_info = -1;    				
    				deleteMessage(e);
    				removeNextMessage = true;
    				addBedwarsMeowMessageToQuee("Я без пати", false);
            	}
            	...
            	if (split != null && split.length == 3 && split[0].contains("Информация о пати")) {
            		...
            		try {
            			...
            			for (String m: members_line) {
            				name = m.trim().split(" ")[0];
            				if (m.contains("§c●") || name.equals(creator_name)) continue;
            				members.add(name);
            			}
            			myParty = new MyParty(creator_name, members);
            			
            			if (bwmanipulator_party_info == 1) {
            				bwmanipulator_party_info = -1;
            				String s = "";
            				for (String m: myParty.members) {
            					s += m + ", ";
            				}
            				...
            				ChatSender.sendText("!Я в пати " + myParty.creator + ", учасники: " + s);
            			} else {
            				playSound(SOUND_PARTY_CHAT);
            			}
            ...
            case CHAT_LOBBY_PARTY_NEW_LEADER:
            	...
            	playSound(SOUND_PARTY_CREATED);
            	//ChatSender.addText("Your name = &a" + Minecraft.getMinecraft().thePlayer.getName());
            	setMessageText(e, str);
            	break;
            ...
            case CHAT_LOBBY_STATS_CATEGORY:
            	...
            	String placeColor = "&0";
            	try {
            		int x = Integer.parseInt(vals[3].trim());
            		placeColor = "&8";
            		if (x < 5000) placeColor = "&7";
            		if (x < 2000) placeColor = "&f";
            		if (x < 1000) placeColor = "&a";
            		if (x < 100) placeColor = "&e&l";
            		if (x == 0) placeColor = "&c";
            		if (x == -1) placeColor = "&0";
                ...
                int place_cnt = -1;
                try {
            		cnt = Integer.parseInt(vals[2].trim());
            		place_cnt = Integer.parseInt(vals[3].trim());
            	} catch (Exception ex) {}	
                ...
                if (cnt != -1) {
	                ...
	                if (category.contains("Килов")) {
	                	...
	                	if (myStatistic.category_games_cnt > 0) {
		                	float percentage = (float)((double)myStatistic.category_wins_cnt / (double)(myStatistic.category_games_cnt) * 100);
	                	...
	                	if (myStatistic.category_deathes_cnt > 0) {
		                	float kdr = (float)Math.round((double)myStatistic.category_kills_cnt / (double)myStatistic.category_deathes_cnt * 100) / 100;
		                	String color = "&0";
		                	if (kdr < 0.7) {
		                		player_mark += 1;
		                		color = "&c";
	                	...
	                	if (myStatistic.category_games_cnt > 0) {
		                	float bpg = (float)Math.round((double)myStatistic.category_beds_cnt / (double)myStatistic.category_games_cnt * 10) / 10;
		                	String color = "&0";
		                	if (bpg < 0.7) {
		                		player_mark += 1;
		                		color = "&c";
	                	...
	                	int treshold = 200;
	                	if (myStatistic.category_kills_cnt < treshold &&
	                			myStatistic.category_deathes_cnt < treshold &&
	                			myStatistic.category_games_cnt < treshold &&
	                			myStatistic.category_wins_cnt < treshold &&
    ...
    public static TEAM_COLOR getEntityTeamColor(EntityPlayer en) {
    	...
    	if (en.getTeam() == null) return TEAM_COLOR.NONE;
		String team_name = en.getTeam().getRegisteredName();
		if (team_name == null) return TEAM_COLOR.NONE;			
    ...
    public static String getHoverMessage(IChatComponent message) {
    	for (IChatComponent component: message.getSiblings()) {
    		if (component.getChatStyle() == null || component.getChatStyle().getChatHoverEvent() == null || component.getChatStyle().getChatHoverEvent().getValue() == null) continue;
    ...
    public static void sendUpdateModMessage() { 
    	...
    	if (link == null || last_version == null) return;
